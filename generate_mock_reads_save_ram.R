#This script takes in a mock genome and takes random draws to simulate illumina-like 101bp reads
#whcih can then be used in read depth analysis. This creates paired-end (-1, -2) reads.
...
ill_df_1<- foreach(n = 1:1000000, .combine = rbind)  %dopar%  Fragment(string= wsg_1)
...
write.table(ill_df_1_fasta, "synthreads_10M_w_cleanup.fasta", append = TRUE, na = "NA", quote =FALSE, col.names = FALSE, row.names = FALSE)

#2
ill_df_2<- foreach(n = 1:1000000, .combine = rbind)  %dopar%  Fragment(string= wsg_2)
...
write.table(ill_df_2_fasta, "synthreads_10M_w_cleanup.fasta", append = TRUE, na = "NA", quote =FALSE, col.names = FALSE, row.names = FALSE)

#3
ill_df_3<- foreach(n = 1:1000000, .combine = rbind)  %dopar%  Fragment(string= wsg_3)
...
write.table(ill_df_3_fasta, "synthreads_10M_w_cleanup.fasta", append = TRUE, na = "NA", quote =FALSE, col.names = FALSE, row.names = FALSE)


#4
ill_df_4<- foreach(n = 1:1000000, .combine = rbind)  %dopar%  Fragment(string= wsg_4)
...
write.table(ill_df_4_fasta, "synthreads_10M_w_cleanup.fasta", append = TRUE, na = "NA", quote =FALSE, col.names = FALSE, row.names = FALSE)

#5
ill_df_5<- foreach(n = 1:1000000, .combine = rbind)  %dopar%  Fragment(string= wsg_5)
...
write.table(ill_df_5_fasta, "synthreads_10M_w_cleanup.fasta", append = TRUE, na = "NA", quote =FALSE, col.names = FALSE, row.names = FALSE)

#6
ill_df_6<- foreach(n = 1:1000000, .combine = rbind)  %dopar%  Fragment(string= wsg_6)
...
write.table(ill_df_6_fasta, "synthreads_10M_w_cleanup.fasta", append = TRUE, na = "NA", quote =FALSE, col.names = FALSE, row.names = FALSE)

#7
ill_df_7<- foreach(n = 1:1000000, .combine = rbind)  %dopar%  Fragment(string= wsg_7)
...
write.table(ill_df_7_fasta, "synthreads_10M_w_cleanup.fasta", append = TRUE, na = "NA", quote =FALSE, col.names = FALSE, row.names = FALSE)

#8
ill_df_8<- foreach(n = 1:1000000, .combine = rbind)  %dopar%  Fragment(string= wsg_8)
...
write.table(ill_df_8_fasta, "synthreads_10M_w_cleanup.fasta", append = TRUE, na = "NA", quote =FALSE, col.names = FALSE, row.names = FALSE)


#9
ill_df_9<- foreach(n = 1:1000000, .combine = rbind)  %dopar%  Fragment(string= wsg_9)
...
write.table(ill_df_9_fasta, "synthreads_10M_w_cleanup.fasta", append = TRUE, na = "NA", quote =FALSE, col.names = FALSE, row.names = FALSE)

#10
ill_df_10<- foreach(n = 1:1000000, .combine = rbind)  %dopar%  Fragment(string= wsg_10)
...
write.table(ill_df_10_fasta, "synthreads_10M_w_cleanup.fasta", append = TRUE, na = "NA", quote =FALSE, col.names = FALSE, row.names = FALSE)
